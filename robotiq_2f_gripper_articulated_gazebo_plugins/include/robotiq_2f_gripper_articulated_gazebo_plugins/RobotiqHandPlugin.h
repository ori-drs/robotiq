...
#ifndef GAZEBO_ROBOTIQ_2F_HAND_PLUGIN_HH
#define GAZEBO_ROBOTIQ_2F_HAND_PLUGIN_HH
...
private:
    void SetHandleCommand(const robotiq_2f_gripper_control::Robotiq2FGripper_robot_output::ConstPtr& _msg);
...
private:
    ...
    /// otherwise.
private:
    bool VerifyCommand(const robotiq_2f_gripper_control::Robotiq2FGripper_robot_output::ConstPtr& _command);
...
private:
    robotiq_2f_gripper_control::Robotiq2FGripper_robot_output handleCommand;

    /// \brief HandleControl message. Last command received before changing the
    /// grasping mode.
private:
    robotiq_2f_gripper_control::Robotiq2FGripper_robot_output lastHandleCommand;
...
private:
    robotiq_2f_gripper_control::Robotiq2FGripper_robot_output prevCommand;

    /// \brief Original HandleControl message (published by user and unmodified).
private:
    robotiq_2f_gripper_control::Robotiq2FGripper_robot_output userHandleCommand;
...
private:
    robotiq_2f_gripper_control::Robotiq2FGripper_robot_input handleState;
...
private:
    PubQueue<robotiq_2f_gripper_control::Robotiq2FGripper_robot_input>::Ptr pubHandleStateQueue;
...
#endif  // GAZEBO_ROBOTIQ_2F_HAND_PLUGIN_HH
